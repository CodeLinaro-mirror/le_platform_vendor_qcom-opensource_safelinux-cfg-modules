 ...
 */
extern bool qtee_shmbridge_is_enabled(void);
 ...
 * return 0 or -EEXIST
 */
extern int32_t qtee_shmbridge_query(phys_addr_t paddr);
 ...
 */
extern int32_t qtee_shmbridge_register(
		phys_addr_t paddr,
		size_t size,
 ...
 * return success or error
 */
extern int32_t qtee_shmbridge_deregister(uint64_t handle);
 ...
 */
extern int32_t qtee_shmbridge_allocate_shm(size_t size, struct qtee_shm *shm);
 ...
 *
 */
extern void qtee_shmbridge_free_shm(struct qtee_shm *shm);
 ...
 *
 */
extern void qtee_shmbridge_flush_shm_buf(struct qtee_shm *shm);
 ...
 *
 */
extern void qtee_shmbridge_inv_shm_buf(struct qtee_shm *shm);
